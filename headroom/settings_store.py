...
SETTINGS: tuple[SettingField, ...] = (
    ...
    SettingField(
        ...
        help="Optional Jev retention planning; active is reserved until CCR safety gates ship.",
        tier="advanced",
    ),
    SettingField(
        ...
        "str",
        default=None,
        help="TypeSafe Jev API key. Stored and displayed as a secret.",
        secret=True,
        tier="advanced",
    ),
    SettingField(
    ...
    SettingField(
        ...
        "jev_max_candidate_tokens",
        "Jev candidate budget",
        "Jev",
        "int",
        default=20_000,
        minimum=1,
